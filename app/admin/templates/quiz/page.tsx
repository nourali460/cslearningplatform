      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-3xl font-bold flex items-center gap-2">
            ...
            ❓ {editId ? 'Edit' : 'Create'} Quiz Template
          </h1>
      ...
      <Card className="border-dashed">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-muted-foreground">
            <div>• Question builder (multiple choice, true/false, short answer, essay)</div>
            <div>• Question bank with randomization</div>
            <div>• Auto-grading for objective questions</div>
            <div>• Time limits and enforcement</div>
            <div>• Question and answer randomization</div>
            <div>• Partial credit configuration</div>
          </div>
        </CardContent>
      </Card>
    </div>
